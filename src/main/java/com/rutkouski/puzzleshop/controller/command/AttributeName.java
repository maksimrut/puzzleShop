...
public final class AttributeName {
    ...
    public static final String INVALID_INPUT = "input_data.invalid";
    public static final String INVALID_LOGIN = "invalid_login";
    public static final String INVALID_MESSAGE = "invalid_message";
    public static final String INVALID_PASSWORD = "invalid_password";
    public static final String NAME_CHANGE_RESULT = "name_change_result";
    public static final String PHONE_CHANGE_RESULT = "phone_change_result";
    ...
    public static final String PROFILE_CHANGE_RESULT = "profile_change_result";
    ...
    public static final String VALID_PROFILE_DATA = "valid_profile_data";
